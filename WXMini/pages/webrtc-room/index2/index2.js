...
Page({
    ...
    wx.request({
      url: 'https://youmowx.zhcloudshare.com/cms/equipment/getWxId',
      data: {
        ...
        if (res1.data.length==0){
          ...
          if (self.data.roomId ==""){
            ...
            wx.request({
              ...
              url: 'https://youmowx.zhcloudshare.com/cms/equipment/getUserSig',
              data: {
                "memberId": userIds
              },
              method: 'get',
            ...
            // var self = this;
            wx.request({
              url: 'https://youmowx.zhcloudshare.com/app/equipment/onlineStartPlay',
              data: {
